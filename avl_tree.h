...
void pre_order_avl_tree(AVL_TREE *avl_tree); //print avl tree in pre-ordem format
void in_order_avl_tree(AVL_TREE *avl_tree); //print avl tree in in-ordem format
void post_order_avl_tree(AVL_TREE *avl_tree); //print avl tree in post-ordem format
